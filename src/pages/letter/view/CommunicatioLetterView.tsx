...
import PrintDownloadButton from "../../../components/button/PrintDownloadButton";
import ReturnButton from "../../../components/modal/letter/ReturnButton";
    ...
    <div className="bg-background p-2">
      <div className="flex flex-col rounded-md gap-2 p-2 overflow-auto">
        <div className="p-2 bg-white rounded-sm overflow-auto">
          <ReturnButton onClick={() => navivage("/home/letters")} />
        ...
        <div className="p-2 bg-white rounded-sm">
          ...
          <PrintDownloadButton placement="right" />
        </div>
      </div>
    </div>
  );
